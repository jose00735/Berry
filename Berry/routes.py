...
from Berry.models import User, Post
from flask import render_template, url_for, flash, redirect, abort
from Berry.forms import RegistrationForm, PostForm, LoginForm, UpdateAccountForm
from Berry import app, db, bcrypt
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Account created for {form.username.data}!','alert alert-dismissible alert-success')
        return redirect(url_for('home'))
